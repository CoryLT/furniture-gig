...
// ============================================================
// Marks the caller's listing as sold (sets status='sold' and
// sold_at=now). Only the seller (or admin) can call this.
// ============================================================
...
export async function POST(
  ...
  if (error) {
    console.error('[marketplace/sold] update error:', error)
