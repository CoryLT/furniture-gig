...
export default async function MessagesLayout({ children }: { children: React.ReactNode }) {
  ...
  // Look up role + a username for the nav
  ...
  // Try worker_profiles first, fall back to flipper_profiles
  ...
  if (!username) {
    ...
    if (!displayName && flipperProfile?.business_name) displayName = flipperProfile.business_name
  }
